...
<body class="is-preload">
	...
	<!-- Header start -->
		<!-- Header -->
		<header id="header">
			<a class="logo" href="../index.html">   Transform <span>For Equity</span> <img src="../images/butterfly.png" style="vertical-align: top; float: left;" height="30px"/></a>
			<nav>
		...
		<section class="cd-section index4 visible">
			<div class="cd-content style4">
                ...
                <span class="invalid-feedback"><?php echo $password_err; ?></span>
												...
												<div class="form-group">
													<input type="submit" class="submit" value="Login" onclick="psswrd()">
												</div>
											</form>
	...
	<script type="text/javascript">
		var jQuery_3_6_0 = $.noConflict(false);
	</script>
	...
	<script type="text/javascript">
		var jQuery_1_2_2 = $.noConflict(false);
	</script>
